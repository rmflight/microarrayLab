...
However, some of the information is not linked the same way in GEOmetadb. For example, it is easy to find **datasets** related to human diabetes, but more complicated to find **series**.
```{r geoQueries}
