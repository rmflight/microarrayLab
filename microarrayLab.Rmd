...
celDir <- "GSE10797_RAW"
setwd(celDir)
celDat <- read.affybatch(filenames=dir(),cdfname="hgu133plus2cdf")
...
```{r qualityMetrics}
arrayQualityMetrics(celDat, outdir="rawData", do.logtransform=T, intgroup=c("tissueType", "cancerType"), spatial=F)
```